...
import static com.cloudring.arrobot.gelin.download.Utils.GMTToLong;
import static com.cloudring.arrobot.gelin.download.Utils.longToGMT;
import static com.cloudring.arrobot.gelin.download.Utils.mkdirs;
import static com.cloudring.arrobot.gelin.download.Utils.notEmpty;
import static java.io.File.separator;
import static java.nio.channels.FileChannel.MapMode.READ_WRITE;
import static okhttp3.internal.Util.closeQuietly;

/**
 * Created by luoren on 2017/6/22.
 */
...
//    }
    ...
    public static String getDownloadApkCachePath() {
        ...
        if (checkSDCard()) {
            appCachePath = Environment.getExternalStorageDirectory() + "/MediaPlayerDownload/" ;
        } else {
            appCachePath = Environment.getDataDirectory().getPath() + "/MediaPlayerDownload/" ;
        }
